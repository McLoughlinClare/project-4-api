...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { answer: @solution.answer, challenge_id: @solution.challenge_id, correct: @solution.correct, student_id: @solution.student_id } }, as: :json
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { answer: @solution.answer, challenge_id: @solution.challenge_id, correct: @solution.correct, student_id: @solution.student_id } }, as: :json
    assert_response 200
  end
